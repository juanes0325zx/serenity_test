...
public class menu {
    ...
    public static By LOANS = By.xpath(Xpath_element.getByText_li_Class_Span ("has-sub-menu","Loans"));
    public static By MORTAGAGES = By.xpath(Xpath_element.getByText_li_Class_Span ("has-sub-menu","Mortgages"));
}
